##Connect to Azure AD and MSOL Services
Connect-AzureAD
Connect-MsolService
...
#Set users location to US and and assign the licenses. Users are entered in email format; username@domain.com
Get-Content "C:\users\test\documents\UsersToLicense.csv" | ForEach {
